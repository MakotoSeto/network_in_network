...
class MlpConv(nutszebra_chainer.Model):
    ...
    def count_parameters(self):
        ...
        for name, link in self.modules:
            count += MlpConv._count_conv_parameters(link)
        return count
...
class Network_In_Network(nutszebra_chainer.Model):
    ...
    def __init__(self, category_num):
        ...
        modules = []
        modules += [('mlpconv1', MlpConv(3, (192, 160, 96), (5, 1, 1), (1, 1, 1), (2, 0, 0)))]
        modules += [('mlpconv2', MlpConv(96, (192, 192, 192), (5, 1, 1), (1, 1, 1), (2, 0, 0)))]
        modules += [('mlpconv3', MlpConv(192, (192, 192, category_num), (3, 1, 1), (1, 1, 1), (1, 0, 0)))]
        # register layers
        [self.add_link(*link) for link in modules]
        self.modules = modules
